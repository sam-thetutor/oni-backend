...
class ToolSelectionService {
    ...
    async selectTool(userMessage, context) {
        try {
...
- Consider the context of CrossFi DeFi operations`;
    ...
    fallbackToolSelection(userMessage) {
        const lowerMessage = userMessage.toLowerCase();
    ...
    parseDCAParameters(userMessage) {
        const lowerMessage = userMessage.toLowerCase();
...
//# sourceMappingURL=toolSelection.js.map